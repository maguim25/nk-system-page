    ...
    <div>
      ...
      <div className="container-fluid" style={{backgroundColor: '#0B232F'}}>
        <div className="minha-classe">
          <div className="row ">
              <div className="col-sm-6 text-center" style={{paddingTop: 60}}>
                <img src="https://i.ibb.co/MgBcPqq/chipset3.png" className="" style={{width: '140%'}}  />
              </div>
        ...
        <div className="mobile">
          <div className="row ">
              <div className="col-sm-6 text-center" style={{paddingTop: 60}}>
                <img src="https://i.ibb.co/MgBcPqq/chipset3.png" className="" style={{width: '100%'}}  />
              </div>
        ...
        <div className=' container-fluid' style={{backgroundColor: '#F7B41E'}}>
          <div className="container text-center">
            ...
            <div className="row" style={{padding: 50}}>
              ...
              <div className="col-sm-6">
                <img src="https://i.ibb.co/M10PK79/zap-removebg-preview.png" alt=""  className="img-fluid col-sm-8"/>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="minha-classe">
            <div className="row" style={{marginBottom: 100}}>
              ...
              <div className="col-sm-6 text-center">
                <img className="col-sm-8 img-fluid" src="https://i.ibb.co/jWff3jD/vetor-agua.png" alt="" />
              </div>
          ...
          <div className="mobile">
            <div className="row" style={{marginBottom: 100}}>
              ...
              <div className="col-sm-6 text-center" style={{marginTop: 30}}>
                <img className="col-sm-7 img-fluid" src="https://i.ibb.co/jWff3jD/vetor-agua.png" style={{width: 310, left: 0}} alt="" />
              </div>
            </div>
          </div>
          ...
          <div className="container">
            ...
            <h3 className="conteudo-title-yellow my-5">Controle de Estoque Automático</h3>
              ...
              <div className="col-sm-6 text-center" style={{marginTop: 70, marginBottom: 70}}>
                <img className="col-sm-9 img-fluid" src="https://i.ibb.co/dJMgTZT/estoque-galao.png" alt="" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container my-5" >
          <div className="minha-classe">
            <div className="row" style={{marginBottom: 100}}>
              ...
              <div className="col-sm-6 text-center">
                <img className="col-sm-7 img-fluid" src="https://i.ibb.co/ZVqvTTZ/Captura-de-tela-2023-10-04-184250-removebg-preview-1-removebg-preview.png" alt="" />
              </div>
              <div className="col-sm-6" style={{marginTop: 50}}>
          ...
          <div className="row" style={{marginBottom: 100}}>
              ...
              <div className="col-sm-6 text-center" style={{marginTop: 30}}>
                <img className="col-sm-7 img-fluid" src="https://i.ibb.co/ZVqvTTZ/Captura-de-tela-2023-10-04-184250-removebg-preview-1-removebg-preview.png" style={{width: 310, left: 0}} alt="" />
              </div>
            </div>
          </div>
